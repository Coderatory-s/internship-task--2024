    ...
    <>
      ...
      >
        ...
        <ul className="p-4 space-y-4">
          ...
          <li className="px-4 py-2 hover:bg-gray-300 rounded-lg cursor-pointer">
            <button onClick={() => handleNavigation('/signup')}>Registration</button> {/* Redirect to signup */}
          </li>
          <li className="px-4 py-2 hover:bg-gray-300 rounded-lg cursor-pointer">
            <button onClick={() => handleNavigation('/dashboard')}>Dashboard</button> {/* Redirect to dashboard */}
          </li>
        </ul>
